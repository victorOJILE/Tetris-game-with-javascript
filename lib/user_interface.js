+(function() {
 ...
 const ui_controls = {
  ...
  new_game: function() {
   ...
   interval = setInterval(Tetris.moveBox, level);
   Tetris.showNextBox();
   elId('uiLevel').innerText = Tetris.levels.findIndex(function(e) { return e == level });
   elId('backArrowGame').focus();
  },
  level: function() {
